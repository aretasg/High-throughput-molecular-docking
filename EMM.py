...
@author: Aretas
"""
###Performs energy minimization (EMM) on a ligand/small molecule PDB file using AmberTools16.
###You need to have AmberTools16 installed for the script to work
###Uses default settings; can me changed with flag arguments
###Accepts PDB file as a sole input using "-pdb" flag
###Outputs a folder in the PDB input directory with all EMM files including the modified PDB structure
###Tested to work only on bash; should work with Python 2 and 3
...
#Create a separate folder for output files
...
##creates min.i file in the ligand PDB directory
